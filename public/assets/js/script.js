...
const handleAnimalFormSubmit = event => {
  ...
  // USE browser FEtch API to POST data. We have this user-submitted data
  // on the front end that needs to be sent, or POSTed, to the back end
  fetch('/api/animals', {
    method: 'POST',
    headers: {
...
const handleZookeeperFormSubmit = event => {
  ...
  // package the zookeeper's data neatly into an object
  const zookeeperObj = { name, age, favoriteAnimal };

  console.log(zookeeperObj);
  
  // POST the zookeeper's data to zookeeper.json file
